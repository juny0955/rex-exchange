...
```bash
./target/release/integration_stress --scenario full-fill-same-level --warmup-sec 5 --duration-sec 30 --target-commands-per-sec <target> --symbols 1 --sweep-depth 10 --concurrency 128 --settle-timeout-sec 15
```
