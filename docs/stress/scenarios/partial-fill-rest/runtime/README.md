...
```bash
./target/release/runtime_stress --scenario partial-fill-rest --warmup-sec 10 --duration-sec 30 --target-commands-per-sec 50000 --symbols 1 --sweep-depth 10 --timeout-sec 30
```
...
| --- | ---: | ---: | --- |
| [2026-06-09 기준선](./measurements/2026-06-09_baseline.md) | 50,000 commands/s | 55,000 commands/s | [raw](./raw/2026-06-09_baseline.log) |
